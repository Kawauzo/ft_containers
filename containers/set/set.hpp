...
# include "set_iterator.hpp"       // iterator
...
public:
    typedef set_iterator<value_type, node_type>              iterator;
    typedef set_iterator<const value_type, const node_type>  const_iterator;
